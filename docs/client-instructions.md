...
1. Go to [https://smartescrow.raidguild.org/escrow/](https://smartescrow.raidguild.org/escrow/)[RaidID] -- _[raid party lead: replace [RaidID] with the RaidID from Airtable]_

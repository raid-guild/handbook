...
- **Start with #welcome**  
  You’ll land in the #welcome channel, where an introductory message will give you an overview of our community and basic guidelines. Take a moment to read through it—it sets the stage for our culture and expectations within the Guild.

### Step 4: Review the Guild’s Code of Conduct

- **Visit #code-of-conduct**  
  Familiarize yourself with our Code of Conduct in the #code-of-conduct channel. This document lays out the standards for respectful, collaborative behavior within RaidGuild and is essential reading for all members.

### Step 5: Introduce Yourself

- **Head to #introductions**  
...
### Step 7: Explore Channels and Get Involved
...
- **Navigate the Server**  
  ...
  - **#general** for casual discussion and community building
  - **#raids** to discover and discuss current projects and raids

...
<small>Add Network option in MetaMask.</small>

<br>

![](https://i.imgur.com/gSM6FAB.png)
<small>Example of filled form.</small>
...
<small>Send the xDAI to your wallet address.</small>
...
Transaction and swap fees are lower if you use DAI on an L2 chain or sidechain instead of DAI on the Ethereum Mainnet.
...
The Polygon chain used to be known as the Matic Network. The token is still named MATIC.
...
<small>Import tokens and Swap, highlighted with green.</small>

<br>

![Import Tokens screen](https://i.imgur.com/HpKQU4p.png)
<small>Import Tokens screen.</small>
...
<small>Swap options in MetaMask.</small>
<br>

**Swap MATIC to DAI on Honeyswap**
You might get a better deal on swap fees by using a DEX like Honeyswap instead of MetaMask. 
...
<small>Honeyswap swap form with transaction details.</small>

<br>

![](https://i.imgur.com/HStojDL.png)
<small>Pending and Confirmed notification messages.</small>
...
<small>Approve bridging of your DAI.</small>

<br>

![MetaMask permissions](https://i.imgur.com/g96d1P8.png)
<small>Permission request in MetaMask. (Click Edit Permission to set a spend limit)</small>

<br>

![Connext Claim DAI](https://i.imgur.com/Mdas28v.png)
<small>Claim the bridged funds.</small>

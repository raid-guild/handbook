...
To join member-exclusive channels, navigate to the <span class='channels'>#member-join</span> channel on the Raid Guild [Discord server](https://discord.gg/rGFpfQf). Use the `!join` command, then follow Collab.Land’s instructions to verify your `@Raid Guild Member` role. Now, you’re ready to join a Raid!
